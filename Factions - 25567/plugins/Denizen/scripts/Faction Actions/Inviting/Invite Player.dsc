    ...
    script:
        ...
        - else:
            ...
            - else:
                ...
                - narrate "Click <green><underline><element[here ✔].on_click[<entry[accept_invitation_clickable].command>].on_hover[Click to <green>accept<reset> invitation.]><reset> to accept, or <red><underline><element[here ❌].on_click[<entry[decline_invitation_clickable].command>].on_hover[Click to <red>decline<reset> invitation.]><reset> to decline." targets:<[invited_player]> format:faction_action_format
