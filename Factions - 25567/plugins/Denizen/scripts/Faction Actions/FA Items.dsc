...
faction_danger_zone_transfer_ownership_item:
    type: item
    material: player_head
...
faction_danger_zone_delete_faction_item:
    type: item
    material: player_head
